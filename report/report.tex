...
\section{Theory}
  ...
  \section{Translation of First-order Predicate Logic to SQL}
    ...
    \begin{gather}
      \exists x(films\_name(x, name)) \label{select1}
    \end{gather}
    ...
    variables, such as:
    \begin{gather}
      films\_name(x, name) \label{select2}
    \end{gather}
  ...
  \subsection{SQL WHERE}
    ...
    \subsubsection{Equality}
      ...
      \begin{gather}
        \exists x(films\_name(x, y) \land y = \text{'The Bourne
        Identity'})\label{where1}\\
        films\_name(x, \text{'The Bourne Identity'})\label{where2}
      \end{gather}
    ...
    \subsubsection{Inequality}
      ...
      \begin{gather}
        ...
        \lnot films\_name(x, \text{'The Bourne Identity'})\label{where4}
      \end{gather}
      ...
      \{$films.fid$\} such that the name associated with that particular
