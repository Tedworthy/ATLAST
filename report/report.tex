...
\todo{Give examples of logic sentences that are far simpler to write and understand
...
\subsection{Mapping Tuple Relational Calculus to First-order Predicate Logic}
  ...
  \subsection{Conjunction of Predicates}
    ...
    \subsubsection{SQL CROSS JOIN}
      ...
      we could use the following logic query.
...
\section{Appendix}
  ...
  \subsection{Design Diagrams}
     \begin{figure}[H]
      \centering
      \includegraphics[width=0.9\textwidth]{images/umlisloveley.png}
      \caption{LOLLUML IS KEWL}
    \end{figure} 
