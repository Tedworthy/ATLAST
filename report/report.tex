...
\section{Executive Summary}
  ...
  In the world of computer security access to data is an important
  ...
  abstracts away from any database where customer data is stored. This would 
  allow questions to be asked (in logic) by the government, run through a 
  constraints checker, and if valid, answered in a manner respecting the
  ...
  method of converting English into predicate logic (Tom: there is nowhere
  near such a system - Ian H in 1st year said people had written whole books
  on why it is difficult), it would be trivial to
...
\subsection{Mapping Tuple Relational Calculus to First-order Predicate Logic}
    ...
    \subsubsection{Set Membership}
      ...
      this problem there are a few different solutions.
...
\section{Design and Implementation}
  ...
  \subsection{Middleware}
    ...
    \subsubsection{Generating a Symbol Table}
      ...
      Below are justifications for the use of a symbol table, and
      implementation details.

      \subsubsubsection{Scoping}

      \subsubsubsection{Unification}

      \subsubsubsection{Free and Bound Variables}
...
\section{Appendix}
  ...
  \todo[inline]{Just put screenshots of the schemas from our UI here.}

    \subsubsection{filmdb}
