...
\section{Design and Implementation}
  ...
  \subsection{Middleware plugins}
    ...
    \subsubsection{Interfacing with the databse}
      The psycopg2 (http://initd.org/psycopg/ ) PostgreSQL adapter for Python
      was used to run queries on the database. It was very simple to open a
      connection to a database   

      \begin{verbatim}
        Running generated sql queries was very easy:
