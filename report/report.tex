...
\todo[inline]{Evaluate your deliverables e.g. performance, usability, etc.
  ...
  Well this doesn't sound like Chatley BS at all.

  \subsection{Performance}

  \subsection{Usability}

  \subsection{Problems encountered and changes to the project plan}
  We kept thinking up issues with how to translate the logic.

  Changed the timeplan when we couldn't translate anything for weeks and weeks.
