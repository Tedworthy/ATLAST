...
\section{Executive Summary}
  ...
  be as secretive as not even allowing the government to know what kinds of
  data you hold. What you would like is a system which would allow the
  government to ask you a question, and for you to be able to respond with as
  ...
  conditions surrounding it hold, our project then takes this query and
  translates it into SQL, so that it is ready to be sent to a conventional
  database.


  Another compelling use for our project would be to provide a teaching tool, 
  suitable for use by students studying both logic and databases, topics which
  many universities deem to be mandatory for all computing students.To reinforce 
  their understanding of logic, queries can be written and tested against a suitably
  populated database of facts. The result of these queries can then be used to
  see if the student has understood the course material. 
  
  The generated SQL can be used as a reference for the student, either to  highlight 
  issues with the logic or, to  explain the formulation of correct SQL.
