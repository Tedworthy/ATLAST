...
\subsection{Mapping Tuple Relational Calculus to First-order Predicate Logic}
  ...
  \subsection{SQL EXISTS}
    ...
    \begin{multline}
      \exists x(film\_director(x, director) \land \forall y(film\_director(y,
      director) \land film\_length(y, length) \land length > '1:00:00'))
    \end{multline}
    We can think of this equivalently as the following SQL query.
