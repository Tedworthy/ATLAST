...
%  \subsection{Middleware}
 ...
 % \todo[inline]{
                 ...
                 DONE - Web.py     - Web Server\\
  %}

  REDUNDANT - Having decided on using Python, we considered using Django and web.py as 
  our web servers. We settled with web.py because it was simpler, Django had 
  many features and options, none of which we would ever use and so we chose 
  to keep it simple.
