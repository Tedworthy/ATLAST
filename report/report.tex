  ...
  \subsection{Joins}
    ...
    \subsubsection{Translating to the Correct Join}
      ...
      \begin{table}
        ...
        \tabbox{\centering $rel\_attr1(k, a) \land rel\_attr2(k, b)$ \\ becomes \\  No Join} 
        & 
        ...
        \tabbox{\centering $rel1\_attr1(k1, a) \land rel2\_attr2(k2, b)$ \\ becomes \\ CROSS JOIN} 
        & 
        ...
        \tabbox{\centering $rel1\_attr1(k1, a) \land rel2\_attr2(k2, a)$ \\ becomes \\ JOIN ON \\ rel1.attr1 =
        rel2.attr2} 
        & 
        ...
        \tabbox{\centering $rel1\_attr1(k, a) \land rel2\_attr2(k, b)$ \\ becomes \\ JOIN ON \\ rel1.key =
        rel2.key}
        & 
