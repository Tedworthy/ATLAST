...
\section{Theory}
  ...
  \subsection{SQL WHERE}
    ...
    \subsubsection{Logical Connectives}
      ...
      SELECT title
      FROM films
      WHERE films.length >= \text{'2:00:00'} 
        AND films.length <= \text{'3:00:00'};

      SELECT title
      FROM films
      WHERE films.length BETWEEN \text{'2:00:00'} AND \text{'3:00:00'};
      \end{lstlisting}
...
\section{Design and Implementation}
  ...
  We used Python for virtually everything. I'm sure there's a good
  reason... easy/lots of libraries.
