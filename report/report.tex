...
\section{Design and Implementation}
  ...
  \subsection{Front-end site}
    ...
    \subsubsection{Graphical user interface}
      ...
      The interface the user would see and interact with had to be simple
      ...
      user's logic query. The editor was both extremely powerful and very easy to
      implement. The editor provided an almost identical interface to desktop
      applications such as Vim or Emacs. This ensured that  
      ...
      buttons.  This makes it easy for new users to use, and allows experienced users
      faster input.
